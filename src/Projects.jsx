...
export default function Projects() {
  return (
    <div>
        <div className='overall-card' id='/ProjectsPage'>
            <div className="card-1">
                ...
                <span className="see-more"><a href="https://github.com/Soulsanthosh/AI_Car_Parking_system.git" rel="noreferrer" target="_blank">see more &rarr;</a></span>
            </div>
            ...
            <div className="card-2">
                ...
                <span className="see-more"><a href="https://github.com/Soulsanthosh/Attendance_for_Facial_Recognition_using_AI.git" rel="noreferrer" target="_blank">see more &rarr;</a></span>
            </div>
            ...
            <div className="card-3">
                ...
                <span className="see-more"><a href="https://github.com/Soulsanthosh/Book_My_Show_Clone.git" rel="noreferrer" target="_blank">see more &rarr;</a></span>
            </div>
        </div>
    </div>
  )
